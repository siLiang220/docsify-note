**SOURCE:** [美团技术](https://mp.weixin.qq.com/s/JC51S_bI02npm4CE5NEEow)
...
![](https://pic4.zhimg.com/v2-19e2c8c94f379833b38b41ca4d759bdb_b.jpg)
...
![](https://pic4.zhimg.com/v2-79d10e58ddf22fd865bd7ffa2fd24dab_b.jpg)
...
![](https://pic1.zhimg.com/v2-887bbc807200c69b2757bea1b45e73d8_b.jpg)
...
![](https://pic3.zhimg.com/v2-9f7fac70f0ac066f4669b481f77b6026_b.jpg)
...
![](https://pic2.zhimg.com/v2-ae0219c9892e3c116380dd2c3c4cb305_b.jpg)
...
![](https://pic3.zhimg.com/v2-f47607240d12db5dfe67334243465e8e_b.jpg)
...
![](https://pic2.zhimg.com/v2-bf2dd980ab0fc1737676196fa029e77d_b.jpg)
...
![](https://pic1.zhimg.com/v2-bfb13b96fc1bb1feb1aae3a833965678_b.jpg)

看起来没有什么问题，但是使用 LogRecordAnnotation 的方法里面嵌套了另一个使用 LogRecordAnnotation 方法的时候，流程就变成下面的形式：

![](https://pic1.zhimg.com/v2-279274af416fa37384d75c909c8c8cfc_b.jpg)
...
![](https://pic2.zhimg.com/v2-4aacb45b5728ed404a4c52e2ee1cdab9_b.jpg)
...
![](https://pic1.zhimg.com/v2-682a3e3c63227cee5a976b9be2fb31dc_b.jpg)
...
业务可以实现这个保存接口，然后把日志保存在任何存储介质上。这里给了一个 2.2 节介绍的通过 [http://log.info](https://link.zhihu.com/?target=http%3A//log.info) 保存在日志文件中的例子，业务可以把保存设置成异步或者同步，可以和业务放在一个事务中保证操作日志和业务的一致性，也可以新开辟一个事务，保证日志的错误不影响业务的事务。业务可以保存在 Elasticsearch、数据库或者文件中，用户可以根据日志结构和日志的存储实现相应的查询逻辑。
...
## 5\. 参考文章
- [美团技术-如何优雅的记录操作日志](https://tech.meituan.com/2021/09/16/operational-logbook.html)
- [美团操作日志实现]https://github.com/mouzt/mzt-biz-log
- [SpringBoot+MDC实现全链路调用日志跟踪，这才叫优雅！ - 脉脉 (maimai.cn)](https://maimai.cn/article/detail?fid=1708741427&efid=CcrJvMmJhhDxum--6ZTsqA)